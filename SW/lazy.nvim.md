...
`string?` or `string[]` or `fun(self:LazyPlugin, event:string[]):string[]` or `{event:string[]|string, pattern?:string[]|string}`
...
[](https://github.com/folke/lazy.nvim#-other-neovim-plugin-managers-in-lua)
